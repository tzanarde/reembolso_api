...
RSpec.describe "Users", type: :request do
  ...
  #               delete "/users/999", headers: headers
  ...
  #         it 'returns unauthorized' do
  #           delete "/users/#{employee_to_delete.id}", headers: headers
  ...
  #               delete "/users/#{manager.id}", headers: headers
  ...
  #         it 'returns unauthorized' do
  #           delete "/users/#{manager_to_delete.id}", headers: headers
